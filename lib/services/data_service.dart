...
class DataService extends ChangeNotifier {
  ...
  void _initializeData() {
    ...
    _performance = PerformanceModel(
      ...
      leads: 156,
      viewsChart: [
        ChartData(label: 'Mon', value: 1200, date: DateTime.now().subtract(Duration(days: 6))),
        ChartData(label: 'Tue', value: 1850, date: DateTime.now().subtract(Duration(days: 5))),
        ChartData(label: 'Wed', value: 2100, date: DateTime.now().subtract(Duration(days: 4))),
        ChartData(label: 'Thu', value: 1980, date: DateTime.now().subtract(Duration(days: 3))),
        ChartData(label: 'Fri', value: 2400, date: DateTime.now().subtract(Duration(days: 2))),
        ChartData(label: 'Sat', value: 2890, date: DateTime.now().subtract(Duration(days: 1))),
        ChartData(label: 'Sun', value: 3200, date: DateTime.now()),
      ],
      followersChart: [
        ChartData(label: 'Week 1', value: 2650, date: DateTime.now().subtract(Duration(days: 21))),
        ChartData(label: 'Week 2', value: 2720, date: DateTime.now().subtract(Duration(days: 14))),
        ChartData(label: 'Week 3', value: 2790, date: DateTime.now().subtract(Duration(days: 7))),
        ChartData(label: 'Week 4', value: 2840, date: DateTime.now()),
      ],
      leadsChart: [
        PieChartData(label: 'YouTube', value: 45, color: 'FF5722'),
        PieChartData(label: 'Instagram', value: 35, color: 'E91E63'),
        PieChartData(label: 'Facebook', value: 20, color: '2196F3'),
      ],
    );
  }
